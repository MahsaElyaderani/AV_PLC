...
class SingleSrcPMSQE(nn.Module):
    ...
    def forward(self, est_targets, targets, pad_mask=None):
        ...
        pmsqe_frame = (torch.mean((targets - est_targets).pow(2)) +
                        self.alpha * wd_frame + self.beta * wda_frame) * pad_mask
    ...
    def register_16k_constants(self):
        ...
        bark_path = os.path.join(local_path, "/home/ai/Projects/Mahsa/sources/hypersound/hypersound/systems/PMSQE/bark_matrix_16k.mat")
