...
VALID_MASK_RANGES = {'20', '30', '40', '50', '60', '70', 'rand'}
...
class AVDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            if self.mode == 'a':
                return masked_spec, mel_spec, audio_length, mask, video_path
            ...
            if self.mode == 'v':
                ...
                return frames, spk_emb, mel_spec, audio_length, mask, video_path
            ...
            if self.mode == 'av':
                ...
                return frames, spk_emb, masked_spec, mel_spec, audio_length, mask, video_path
...
class AVDataloader:
    ...
    def __init__(self, dataset_name, mode, batch_size, num_workers, video_aug, dropout_modality,
        ...
        if dataset_name == 'grid':
            ...
            base_path = '/home/ai/Projects/Mahsa/datasets/lrs2/'
            self.train_files = base_path + 'lrs2_*train_features_chunk*.h5'
            self.val_files = base_path + 'lrs2_val_features_chunk*.h5'
            self.test_files = base_path + 'lrs2_test_features_chunk*.h5'
    ...
    def _build_loader(self, files_glob, augment, drop_av, subset=None, drop_last=False, shuffle=False, mask_range='rand'):
    ...
    def train_dataloader(self):
        return self._build_loader(self.train_files, augment=self.video_aug, drop_av=self.dropout_modality,
                                  subset=self.train_subset, drop_last=False, shuffle=True, mask_range='rand')

    def val_dataloader(self):
        return self._build_loader(self.val_files,   augment=False, drop_av=False,
                                  subset=self.val_subset, drop_last=False,  shuffle=False, mask_range='rand')
    ...
    def test_dataloader(self, mask_range='rand'):
        ...
        return self._build_loader(self.test_files,  augment=False, drop_av=False,
                                  subset=self.test_subset, drop_last=False,  shuffle=False, mask_range=mask_range)
...
if __name__ == "__main__":
    ...
    dataloader = AVDataloader('lrs2', 'av', batch_size=2, num_workers=4,)
    train_loader = dataloader.train_dataloader()
    for batch in train_loader:
        frames, spk_emb, masked_spec, mel_spec, audio_length = batch
